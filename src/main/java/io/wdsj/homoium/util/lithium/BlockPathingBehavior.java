...
public interface BlockPathingBehavior {
     ...
     * <p>
     * If you were mixing into the method {@link WalkNodeProcessor#(IBlockAccess, int, int, int)},
     ...
     * fire or cactus.)
     * <p>
     * If you were mixing into the method {@link WalkNodeProcessor#(IBlockAccess, int, int, int, PathNodeType)}, you will
     * want to implement
